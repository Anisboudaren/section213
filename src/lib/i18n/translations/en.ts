...
export const en = {
  ...
  booking: {
    ...
    deposit: {
      ...
      manualTransfer: "CCP / Baridi Mob transfer",
      chargilly: "Chargilly (online)",
      chargillyPay: "Pay with Chargilly",
      chargillySoon: "Online payment via Chargilly is coming soon. Your request will still be recorded.",
