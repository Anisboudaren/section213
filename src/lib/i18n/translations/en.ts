export const en = {
  ...
  hero: {
    location: "Based in Oran, Algeria — serving businesses across the Maghreb and worldwide",
    headlineGold: "DIGITALIZE YOUR BUSINESS",
    headlineRest: "— CONTENT, CODE & AUTOMATIONS.",
    bullet1: "Cinematic photo, video, and social content that makes your brand go viral.",
    bullet2:
      "Websites, apps, and business automations — built by the same team that handles your marketing and media.",
    ourPackages: "Our Packages",
    seeViralReels: "See viral reels",
    enableSound: "Enable sound",
    scroll: "Scroll",
    scrollToReels: "Scroll to viral reels section",
  },
  reels: {
  ...
  booking: {
    steps: ["Date", "Project", "Objective", "Offer", "Contact"],
    next: "Next",
    previous: "Back",
    select: "Select",
    ...
    recap: {
      title: "Your details",
      hint: "We'll get back to you within 24 hours.",
      submit: "Confirm my request",
      submitting: "Sending…",
    },
    projectTypes: {
      shooting_video: "Video shoot",
      shooting_photo: "Photo shoot",
    ...
    objectives: {
      notoriete: "Brand awareness",
      conversion: "Sales & leads",
      engagement: "Community & social",
      confiance: "Trust & credibility",
      autre: "Other",
    },
    budgetRanges: {
      under_50k: "Under 50,000 DZD",
      "50k_150k": "50,000 – 150,000 DZD",
      "150k_300k": "150,000 – 300,000 DZD",
      over_300k: "Over 300,000 DZD",
      flexible: "Flexible",
    },
    charCount: "{count}/500",
    ...
    confirmation: {
      title: "Request sent!",
      message: "Your request has been sent. Our team will contact you within 24 hours.",
      home: "Back to home",
