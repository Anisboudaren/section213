...
export const en = {
  ...
  homeV2: {
    ...
    bookCta: {
      ...
      subtitle:
        "Pick a date, tell us about your project, and choose your offer — we'll call you to plan next steps.",
      cta: "Reserve a call",
    },
  },
  booking: {
    title: "Book a discovery call.",
    steps: ["Call", "Project", "Objective", "Offer", "Summary"],
    next: "Next",
    previous: "Back",
    select: "Select",
    recommended: "Recommended",
    alaCarteTitle: "À la carte services",
    flexibleDate: "I'm flexible on the call date",
    preferredTimeSlot: "Preferred call time",
    ...
    deposit: {
      ...
      optionADesc:
        "Team confirmation, no immediate payment. If you miss your scheduled call, you won't be able to use this option on future reservations.",
      optionB: "Option B — 50% deposit",
      optionBDesc: "Secure your call slot with a deposit",
    ...
    recap: {
      title: "Summary",
      hint: "Review your information before confirming your call reservation.",
      pricingTitle: "Price estimate",
      contactTitle: "Your details",
      submit: "Reserve my call",
      submitting: "Reserving call…",
    },
    projectTypes: {
      residence: "Residence",
    ...
    confirmation: {
      title: "Call reserved",
      message:
        "Your call reservation is confirmed. Our team will call you at the date and time you selected.",
      home: "Back to home",
    ...
    validation: {
      ...
      min48h: "Call date must be at least 48 hours in the future",
