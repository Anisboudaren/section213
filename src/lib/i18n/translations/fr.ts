...
export const fr: Translations = {
  ...
  nav: {
    ...
    bookAShoot: "Réserver un tournage",
    soundOn: "Son activé",
  ...
  hero: {
    location:
      "Basés à Oran, Algérie — nous accompagnons les entreprises au Maghreb et dans le monde entier",
    headlineGold: "DIGITALISEZ VOTRE ENTREPRISE",
    headlineRest: "— CONTENU, CODE & AUTOMATISATIONS.",
    bullet1:
      "Photo, vidéo et contenu social cinématographique qui fait exploser la visibilité de votre marque.",
    bullet2:
      "Sites web, applications et automatisations métier — conçus par la même équipe qui gère votre marketing et vos médias.",
    ourPackages: "Nos forfaits",
    seeViralReels: "Voir les reels viraux",
    enableSound: "Activer le son",
    scroll: "Défiler",
    scrollToReels: "Défiler vers la section reels viraux",
  },
  reels: {
  ...
  booking: {
    steps: ["Date", "Projet", "Objectif", "Offre", "Contact"],
    next: "Suivant",
    previous: "Précédent",
    select: "Sélectionner",
    ...
    deposit: {
      ...
      manualTransfer: "Virement CCP / Baridi Mob",
      chargilly: "Chargilly (en ligne)",
      chargillyPay: "Payer avec Chargilly",
      chargillySoon: "Le paiement en ligne via Chargilly sera disponible très bientôt. Votre demande sera enregistrée.",
      transferProof: "Justificatif de virement",
    },
    recap: {
      title: "Vos coordonnées",
      hint: "Nous vous recontactons sous 24 h.",
      submit: "Confirmer ma demande",
      submitting: "Envoi en cours…",
    },
    projectTypes: {
      shooting_video: "Tournage vidéo",
      shooting_photo: "Shooting photo",
      reels_content: "Reels & contenu",
      website: "Site web",
    ...
    objectives: {
      ...
      confiance: "Confiance & crédibilité",
      autre: "Autre",
    },
    budgetRanges: {
      under_50k: "Moins de 50 000 DZD",
      "50k_150k": "50 000 – 150 000 DZD",
      "150k_300k": "150 000 – 300 000 DZD",
      over_300k: "Plus de 300 000 DZD",
      flexible: "Flexible",
    },
    charCount: "{count}/500",
    ...
    validation: {
      ...
      min48h: "La date doit être au moins 48h dans le futur",
