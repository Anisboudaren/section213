...
export const fr: Translations = {
  ...
  homeV2: {
    ...
    bookCta: {
      ...
      subtitle:
        "Planifiez votre lancement — date, projet, objectif et accompagnement. Pas un formulaire, un planning.",
      cta: "Réserver un projet",
    },
  },
  booking: {
    title: "Lancez votre projet.",
    steps: ["Date", "Projet", "Objectif", "Offre", "Récap"],
    next: "Suivant",
    previous: "Précédent",
    select: "Sélectionner",
    ...
    recap: {
      title: "Récapitulatif",
      hint: "Vérifiez les informations avant de confirmer votre réservation.",
    ...
    confirmation: {
      ...
      message:
        "Votre réservation a été enregistrée. Notre équipe vous contactera dans les 24h pour finaliser les détails.",
