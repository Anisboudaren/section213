export const adminEn = {
  ...
  testimonials: {
    title: "Testimonials",
    titleHighlight: "Section",
    description: "Manage the homepage client testimonials — quotes, photos, and details.",
    addTestimonial: "Add testimonial",
    editTestimonial: "Edit testimonial",
    testimonialCreated: "Testimonial added.",
    testimonialUpdated: "Testimonial updated.",
    testimonialDeleted: "Testimonial removed.",
    role: "Role / title",
    roleHint: "Job title, e.g. Responsable marketing",
    company: "Company / brands",
    companyHint: "Brands line shown under the name.",
    quoteEn: "Quote (English)",
    quoteFr: "Quote (French)",
    quoteAr: "Quote (Arabic)",
    quoteArHint: "Optional — falls back to French/English when empty.",
    photo: "Photo",
    photoHint: "Optional — an initials avatar is shown when no photo is set.",
    instagram: "Instagram handle",
    instagramHint: "Without the @, e.g. youcefbm",
    email: "Email",
    emailHint: "Optional — internal reference, not shown on the site.",
    activeHint: "Hidden testimonials stay in admin but are not shown on the site.",
    resetDefaults: "Restore default testimonials",
    resetDone: "Default testimonials restored.",
    emptyTitle: "No testimonials yet",
    emptyDescription: "Add client testimonials or restore the default set.",
    deleteTitle: "Remove this testimonial?",
    deleteDescription: "This testimonial will be removed from the homepage.",
  },
  offers: {
    title: "Offers",
    addOffer: "Add Offer",
  ...
  users: {
    ...
    passwordHint: "Only fill this in if you want to reset the user's password.",
    activeAccount: "Active account",
    activeAccountHint: "Inactive users cannot sign in.",
    noAccess: "You do not have permission to manage users.",
    emptyTitle: "No users yet",
    emptyDescription: "Add team members who can sign in to the admin.",
    roles: {
