...
function toDto(row: PrismaSiteSettings): SiteSettingsDto {
  return {
    ...
    contactEmail: row.contactEmail || DEFAULT_SITE_SETTINGS.contactEmail || undefined,
    contactPhone: row.contactPhone || DEFAULT_SITE_SETTINGS.contactPhone || undefined,
    contactAddress: row.contactAddress || DEFAULT_SITE_SETTINGS.contactAddress || undefined,
    contactCity: row.contactCity || DEFAULT_SITE_SETTINGS.contactCity || undefined,
    contactHoursFr: row.contactHoursFr || DEFAULT_SITE_SETTINGS.contactHoursFr || undefined,
    contactHoursEn: row.contactHoursEn || DEFAULT_SITE_SETTINGS.contactHoursEn || undefined,
    whatsappNumber: row.whatsappNumber || DEFAULT_SITE_SETTINGS.whatsappNumber || undefined,
    instagramHandle: row.instagramHandle || DEFAULT_SITE_SETTINGS.instagramHandle || undefined,
    facebookUrl: row.facebookUrl || DEFAULT_SITE_SETTINGS.facebookUrl || undefined,
    tiktokHandle: row.tiktokHandle || DEFAULT_SITE_SETTINGS.tiktokHandle || undefined,
    youtubeUrl: row.youtubeUrl || DEFAULT_SITE_SETTINGS.youtubeUrl || undefined,
    linkedinUrl: row.linkedinUrl || DEFAULT_SITE_SETTINGS.linkedinUrl || undefined,
    mapsUrl: row.mapsUrl || DEFAULT_SITE_SETTINGS.mapsUrl || undefined,
