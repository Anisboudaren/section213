        ...
        <div className="mt-7 flex flex-col gap-3 sm:mt-8 md:mt-10">
          <div className="flex flex-col items-start gap-2.5 sm:gap-3">
            ...
            <a
              ...
              className="inline-flex w-[13.5rem] items-center justify-center rounded-md border border-white/30 bg-black/30 px-5 py-3 text-sm font-semibold text-white backdrop-blur-sm transition hover:border-white/55 sm:w-[15rem] sm:text-base"
            >
              {t.hero.ctaSecondary}
            </a>
            <button
              ...
              className="hidden w-[15rem] items-center justify-center gap-2 rounded-md border border-white/30 bg-black/20 px-5 py-3 text-sm font-semibold text-white backdrop-blur-sm transition hover:border-white/55 sm:inline-flex sm:text-base"
            >
